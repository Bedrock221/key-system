...
SCRIPT_URL = "https://raw.githubusercontent.com/yuvic123/Skidov1.2-stand/refs/heads/main/vault%20farm"
...
async def setup_panel(ctx):
    ...
    embed = discord.Embed(title="Vault Farm Da Hood", description="Get key now\nSkido Vault Farm", color=0x5865F2)
